...
app = Flask(__name__, template_folder="/content/drive/MyDrive/IBM/Flask/templates")
...
def predict():
    if request.method == "POST":
        if request.files:
            ...
            filepath = os.path.join(basepath, "/content/drive/MyDrive/IBM/Flask/uploads", f.filename)
            f.save(filepath)
